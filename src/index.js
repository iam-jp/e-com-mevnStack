...
const privateKey = fs.readFileSync('/etc/letsencrypt/live/thejasshop.com/privkey.pem')
const certificate = fs.readFileSync('/etc/letsencrypt/live/thejasshop.com/cert.pem')
